...
namespace Inventory_Management_System.Services.ServiceImplementation
{
    public class CheckoutService : ICheckoutService
    {
        ...
        public CheckoutService(ICartRepository cartRepo, IOrderRepository orderRepo, 
            IStoreItemsRepository storeRepo, IPurchaseService purchaseService, 
        ...
        public async Task<int?> CheckoutSelectedItemsCredit(int userId)
        {
            var cart = await _cartRepo.GetCartWithItems(userId);
            ...
            foreach (var ci in selected)
            {
                ...
                decimal itemTotal = storeItem.price * ci.Quantity;
